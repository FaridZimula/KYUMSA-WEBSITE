    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="bg-white rounded-lg shadow-xl p-8 md:p-12 mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">About KYUMSA</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="flex items-center space-x-4 mb-4">
              <Target className="h-10 w-10 text-[#00703C]" />
        ...
        <div className="bg-white rounded-lg shadow-xl p-8 md:p-12 mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <BookOpen className="h-12 w-12 text-[#00703C] mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Islamic Knowledge</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Unity & Brotherhood</h3>
              <p className="text-gray-700">
            ...
            <div className="text-center">
              <Heart className="h-12 w-12 text-[#00703C] mx-auto mb-4" />
